...
# --- MODIFIQUE ESTA LINHA COM A SUA URL RTSP ---
# Formato típico: rtsp://<usuario>:<senha>@<ip>:<porta>/Streaming/Channels/<canal>
# Exemplo (Verifique a documentação da Hikvision para o canal exato):
load_dotenv()
